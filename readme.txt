...
# Once in spyder, PLEASE PRESS RUN FILE WITH THE GREEN TRIANGLE for each script. This should automatically set your working directory to where you downloaded the repository
